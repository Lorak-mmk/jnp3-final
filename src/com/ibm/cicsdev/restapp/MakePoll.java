...
import com.ibm.cicsdev.restapp.bean.MakePollResult;
...
public class MakePoll {
    ...
    @GET
    @Path("/{text}")
    public MakePollResult createPoll(@PathParam("text") String inputStr) {
        ...
        MakePollResult result = new MakePollResult();
